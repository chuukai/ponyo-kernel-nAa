...
//#define PIX2POS_MAX 960
#if 0
#define THRESHOLD_0 900
#define THRESHOLD_1 900
#else
#define THRESHOLD_0 800
#define THRESHOLD_1 840
#endif

#define PIX2POS_MAX 1000

static VRP_HOT_REGION s_KeyHotRegion4[] = {
    {{PIX2POS(0),  PIX2POS(0),  PIX2POS(480),PIX2POS(THRESHOLD_0)}, 0,       0,   TouchHandle, FALSE, TRUE,  TRUE, NULL},
    {{PIX2POS(0),  PIX2POS(THRESHOLD_1),PIX2POS(90), PIX2POS(PIX2POS_MAX)}, KEY_BACK,   1,      HotHandle,   FALSE, FALSE, FALSE, NULL},
    {{PIX2POS(130), PIX2POS(THRESHOLD_1),PIX2POS(220),PIX2POS(PIX2POS_MAX)}, KEY_MENU,   2,      HotHandle,   FALSE, FALSE, FALSE, NULL},
    {{PIX2POS(260),PIX2POS(THRESHOLD_1),PIX2POS(350),PIX2POS(PIX2POS_MAX)}, KEY_HOME,      3,      HotHandle,   FALSE, FALSE, FALSE, NULL},
    {{PIX2POS(390),PIX2POS(THRESHOLD_1),PIX2POS(480),PIX2POS(PIX2POS_MAX)}, KEY_SEARCH,    4,      HotHandle,   FALSE, FALSE, FALSE, NULL},
};
...
void LoadDefCfg(VRP_CFG *pstCfg) {
    ...
    pstCfg->rGroup = &s_RegionGroup[3]; 
#endif
#ifdef CONFIG_BIGBANG_TOUCHSCREEN_VRPANEL_KEY
    pstCfg->rGroup = &s_RegionGroup[3]; 
#endif
