...
static const struct mt9d111SY_i2c_reg_conf const init_tbl[] = {
...
static const struct mt9d111SY_i2c_reg_conf const preview_tbl[] = {
...
static const struct mt9d111SY_i2c_reg_conf const snapshot_tbl[] = {

    {0x098E, 0x843C, WORD_LEN, 0},
    {0x843C, 0xFF  , BYTE_LEN, 0},
    {0x8404, 0x02  , BYTE_LEN, 30}
};
static const struct mt9d111SY_i2c_reg_conf const awb_tbl[] = {
...
static const struct mt9d111SY_i2c_reg_conf const MWB_Cloudy_tbl[] = {
    {0x098E, 0x8410, WORD_LEN, 0},
...
static const struct mt9d111SY_i2c_reg_conf const MWB_Day_light_tbl[] = {
	{0x098E, 0x8410, WORD_LEN, 0},
	{0x8410, 0x01  , BYTE_LEN, 0},
	{0x8418, 0x01  , BYTE_LEN, 0},
	{0x8420, 0x01  , BYTE_LEN, 0},
...
static const struct mt9d111SY_i2c_reg_conf const MWB_FLUORESCENT_tbl[] = {
    {0x098E, 0x8410, WORD_LEN, 0},
    {0x8410, 0x01  , BYTE_LEN, 0},
    {0x8418, 0x01  , BYTE_LEN, 0},
    {0x8420, 0x01  , BYTE_LEN, 0},
...
static const struct mt9d111SY_i2c_reg_conf const MWB_INCANDESCENT_tbl[] = {
	{0x098E, 0x8410, WORD_LEN, 0},
	{0x8410, 0x01  , BYTE_LEN, 0},
	{0x8418, 0x01  , BYTE_LEN, 0},
	{0x8420, 0x01  , BYTE_LEN, 0},
...
//effect
static const struct mt9d111SY_i2c_reg_conf const EFFECT_OFF_tbl[] = {
...
static const struct mt9d111SY_i2c_reg_conf const EFFECT_MONO_tbl[] = {
	{0x098E, 0xDC38, WORD_LEN, 0},
...
static const struct mt9d111SY_i2c_reg_conf const EFFECT_SEPIA_tbl[] = {
	{0x098E, 0xDC38, WORD_LEN, 0},
...
static const struct mt9d111SY_i2c_reg_conf const EFFECT_NEGATIVE_tbl[] = {
	{0x098E, 0xDC38, WORD_LEN, 0},
...
static const struct mt9d111SY_i2c_reg_conf const EFFECT_SOLARIZE_tbl[] = {
	{0x098E, 0xDC38, WORD_LEN, 0},
...
static const struct mt9d111SY_i2c_reg_conf const BRIGHTNESS_H0_tbl[] = {
	{0x098E, 0xA409, WORD_LEN, 0},
	{0xA409, 0x37  , BYTE_LEN, 0},
};

static const struct mt9d111SY_i2c_reg_conf const BRIGHTNESS_H1_tbl[] = {
	{0x098E, 0xA409, WORD_LEN, 0},
	{0xA409, 0x3C  , BYTE_LEN, 0},
};

static const struct mt9d111SY_i2c_reg_conf const BRIGHTNESS_H2_tbl[] = {
	{0x098E, 0xA409, WORD_LEN, 0},
	{0xA409, 0x41  , BYTE_LEN, 0},
};

static const struct mt9d111SY_i2c_reg_conf const BRIGHTNESS_H3_tbl[] = {
	{0x098E, 0xA409, WORD_LEN, 0},
	{0xA409, 0x46  , BYTE_LEN, 0},
};

static const struct mt9d111SY_i2c_reg_conf const BRIGHTNESS_L1_tbl[] = {
	{0x098E, 0xA409, WORD_LEN, 0},
	{0xA409, 0x32  , BYTE_LEN, 0},
};

static const struct mt9d111SY_i2c_reg_conf const BRIGHTNESS_L2_tbl[] = {
	{0x098E, 0xA409, WORD_LEN, 0},
	{0xA409, 0x2D  , BYTE_LEN, 0},
};

static const struct mt9d111SY_i2c_reg_conf const BRIGHTNESS_L3_tbl[] = {
	{0x098E, 0xA409, WORD_LEN, 0},
	{0xA409, 0x28  , BYTE_LEN, 0},
};

//AF
static const struct mt9d111SY_i2c_reg_conf const VCM_Enable_full_scan_tbl[] = {
...
static const struct mt9d111SY_i2c_reg_conf const AF_Trigger_tbl[] = {
	{0x098E, 0xB006, WORD_LEN, 0},
	{0xB006, 0x01  , BYTE_LEN, 0},
};

static const struct mt9d111SY_i2c_reg_conf const VCM_Enable_Continue_scan_tbl[] = {
	{0x098E, 0xC400, WORD_LEN, 0},
	{0xC400, 0x88  , BYTE_LEN, 0},
...
//scene
static const struct mt9d111SY_i2c_reg_conf const SCENE_AUTO_tbl[] = {
...
static const struct mt9d111SY_i2c_reg_conf const SCENE_NIGHT_tbl[] = {
	{0x098E, 0xA818, WORD_LEN, 0},
...
struct mt9d111SY_reg mt9d111SY_regs = {
	.init_tbl = init_tbl,
