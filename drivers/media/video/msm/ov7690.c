	...
	unsigned char *txdata, int length)
{
	...
	if (i2c_transfer(ov7690_client->adapter, msg, 1) < 0) {
		CDBG_ZS("ov7690_i2c_txdata failed\n");
		return -EIO;
	}
	...
	unsigned char *rxdata, int length)
{
	...
	if (i2c_transfer(ov7690_client->adapter, msgs, 2) < 0) {
		CDBG_ZS("ov7690_i2c_rxdata failed!\n");
		return -EIO;
	}
	...
	unsigned short raddr, unsigned short *rdata, enum ov7690_width width)
{
	...
	if (rc < 0)
		CDBG_ZS("ov7690_i2c_read failed!\n");
...
*/
		...
		CDBG_ZS("ov7690_reg_init:success!\n");
...
static int32_t ov7690_set_scene(int scene)
{
	...
	CDBG_ZS("ov7690_set_scene:scene=[%d]\n",scene);
	switch (scene) {		
	case CAMERA_BESTSHOT_OFF:
		CDBG_ZS("ov7690_set_scene:CAMERA_SCENE_AUTO\n");
	...
	case CAMERA_BESTSHOT_NIGHT:
		...
		CDBG_ZS("ov7690_set_scene:CAMERA_SCENE_NIGHT\n");
	...
	default: 
		CDBG_ZS("ov7690_set_scene:default\n");
	}
	return rc;
}
...
static long ov7690_set_wb(int wb)
{
	...
	switch(wb){
	case CAMERA_WB_AUTO:
		CDBG_ZS("ov7690_set_wb:CAMERA_WB_AUTO\n");
	...
	case CAMERA_WB_INCANDESCENT :
		CDBG_ZS("ov7690_set_wb:CAMERA_WB_INCANDESCENT\n");
	...
	case CAMERA_WB_FLUORESCENT: 
		CDBG_ZS("ov7690_set_wb:CAMERA_WB_FLUORESCENT\n");
	...
	case CAMERA_WB_DAYLIGHT:
		CDBG_ZS("ov7690_set_wb:CAMERA_WB_DAYLIGHT\n");
	...
	case CAMERA_WB_CLOUDY_DAYLIGHT:
		CDBG_ZS("ov7690_set_wb:CAMERA_WB_CLOUDY_DAYLIGHT\n");
...
static long ov7690_set_effect(int mode, int effect)
	...
	CDBG_ZS("ov7690_set_effect:mode[%d],effect[%d]\n", mode,effect);
#if 1
	switch (effect) {		
	case CAMERA_EFFECT_OFF:

		CDBG_ZS("ov7690_set_effect:CAMERA_EFFECT_OFF\n");
	...
	case CAMERA_EFFECT_MONO:
		CDBG_ZS("ov7690_set_effect:CAMERA_EFFECT_MONO\n");
	...
	case CAMERA_EFFECT_SEPIA:
		CDBG_ZS("ov7690_set_effect:CAMERA_EFFECT_SEPIA\n");
	...
	case CAMERA_EFFECT_NEGATIVE:
		CDBG_ZS("ov7690_set_effect:CAMERA_EFFECT_NEGATIVE\n");	
	...
	case CAMERA_EFFECT_SOLARIZE:
		CDBG_ZS("ov7690_set_effect:CAMERA_EFFECT_SOLARIZE\n");

		break;

	default: 
		CDBG_ZS("ov7690_set_effect:default\n");
	}
#endif
	return rc;
}
...
static long ov7690_set_sensor_mode(int mode)
{
	...
	CDBG_ZS("ov7690_set_sensor_mode:mode[%d]\n", mode);
...
static int ov7690_sensor_init_probe(const struct msm_camera_sensor_info *data)
{
	...
	//CDBG("init entry \n");
	CDBG_ZS("ov7690_sensor_init_probe \n");
	...
	CDBG_ZS("ov7690_sensor_init_probe:ov7690 model_id = 0x%x\n", model_id);
...
init_probe_fail:
	...
	CDBG_ZS("ov7690_sensor_init_probe:failed\n");
	return rc;
}
...
int ov7690_sensor_config(void __user *argp)
{
	...
	CDBG_ZS("ov7690_sensor_config : cfgtype [%d], mode[%d]\n",cfg_data.cfgtype, cfg_data.mode);
	...
	const struct i2c_device_id *id)
{
	...
	CDBG_ZS("ov7690_i2c_probe succeeded!\n");
...
probe_failure:
	...
	ov7690_sensorw = NULL;
	CDBG_ZS("ov7690_i2c_probe failed!\n");
	return rc;
}
